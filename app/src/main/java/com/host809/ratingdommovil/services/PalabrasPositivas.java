 ...
 */
public class PalabrasPositivas extends AsyncTask<String, Void, String> {
    Context ctx;
    ProgressDialog progressDialog;


    public PalabrasPositivas(Context ctx, ProgressDialog progressDialog) {
        this.ctx = ctx;
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            {
            String txt = jsonArray.getJSONObject(i).getString("palabra");

            MainActivity.positivas.add(txt);
            }
