 ...
 */
public class PalabrasNegativas extends AsyncTask<String, Void, String> {
    Context ctx;
    ProgressDialog progressDialog;


    public PalabrasNegativas(Context ctx, ProgressDialog progressDialog) {
        this.ctx = ctx;
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            if(txt!=null)
                MainActivity.negativas.add(txt);
            }
